const Button = ({ children, variant = 'primary', className = '', disabled = false, ...props }) => {
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-blue-600 to-blue-700 dark:from-black dark:to-gray-900 text-white hover:from-blue-700 hover:to-blue-800 dark:hover:from-gray-900 dark:hover:to-black focus:ring-blue-500 dark:focus:ring-gray-600 shadow-md hover:shadow-lg',
